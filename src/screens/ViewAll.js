import { Select, SelectItem, Layout, Text, Input, Button, IndexPath } from '@ui-kitten/components';
    ...
    <>
      <Layout>
        <Layout
          ...
          />
          <Button onPress={onSubmit} style={{ marginVertical: 10 }} size="small">
            Search
          </Button>
        </Layout>
      </Layout>
      <Layout>
        <Layout
          ...
          <Layout
            ...
            <Button onPress={() => setPaginating(paginating - 1)} disabled={paginating === 1}>
              Prev
            </Button>
            <Button
              status="info"
            ...
            <Button onPress={() => setPaginating(paginating + 1)} disabled={movies.length < 4}>
              Next
            </Button>
          </Layout>
        </Layout>
